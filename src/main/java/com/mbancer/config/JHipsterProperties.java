...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "tasker0@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "tasker0 API";

        private String description = "tasker0 API documentation";
